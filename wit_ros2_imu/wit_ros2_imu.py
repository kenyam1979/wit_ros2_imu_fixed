...
def handle_serial_data(raw_data):
    global buff, key, angle_degree, magnetometer, acceleration, angularVelocity, quaternion, pub_flag
    angle_flag = False
    buff[key] = raw_data
    ...
    if key < 11:
        ...
        # elif buff[1] == 0x59:
        #     if check_sum(data_buff[0:10], data_buff[10]):
        #         quaternion = [hex_to_short(data_buff[2:10])[i] / 32768.0 for i in range(0, 3)]
        #         print(quaternion)
        #     else:
        #         print('0x59 Check failure')
        else:
            buff = {}
            key = 0
...
class IMUDriverNode(Node):
    ...
    def imu_data(self):
        ...
        # Quaternion
        # qt_x, qt_y, qt_z, qt_w = quaternion[0], quaternion[1], quaternion[2], quaternion[3]
        ...
        # 動かない
        # self.imu_msg.orientation.x = qt_x
        # self.imu_msg.orientation.y = qt_y
        # self.imu_msg.orientation.z = qt_z
        # self.imu_msg.orientation.w = qt_w
